...
- The local demo completes report jobs synchronously to keep the interview flow reliable. The data model still represents async jobs so production can move model calls to Step Functions or a worker queue.
